  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          base: "hsl(var(--status-base))",
          "base-bg": "hsl(var(--status-base-bg))",
          ...
          "returning-bg": "hsl(var(--status-returning-bg))",
          course: "hsl(var(--status-course))",
          "course-bg": "hsl(var(--status-course-bg))",
          ...
          awol: "hsl(var(--status-awol))",
          "awol-bg": "hsl(var(--status-awol-bg))",
        },
        overlay: {
